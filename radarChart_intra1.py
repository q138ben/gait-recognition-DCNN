...
filePaths = ("D:\\data_aquisition\\gunnar","D:\\data_aquisition\\hui","D:\\data_aquisition\\marcus","D:\\data_aquisition\\yazu_05_08")
...
for filePath in filePaths:
    os.chdir(filePath)
    filenames = glob.glob("all_speed_accuracy_*.npy")
    acc = [np.load(filename) for filename in filenames]
    accSum = accSum + acc

accSum = accSum
accSum = accSum.reshape(5,6)
df1 = pd.DataFrame(data=accSum)
...
filePaths = ("D:\\data_aquisition\\longbin","D:\\data_aquisition\\song","D:\\data_aquisition\\hao","D:\\data_aquisition\\yue","D:\\data_aquisition\\qing",)
...
for filePath in filePaths:
    ...
    filenames = glob.glob("CNN_1Con_0drop_0pool_1FC_512_*_frontal_*_acc.csv")
...
#plt.savefig('C:\\Users\\binbi\\Desktop\\my_phd\\git\\gait-recognition-DCNN\\barPlot_9_intra.png',dpi=400,bbox_inches='tight')
